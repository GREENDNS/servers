...
namespace NeptuneEvo.Core
{
    class Weapons : Script
    {
        ...
        public static Dictionary<ItemType, string> WeaponsSlots = new Dictionary<ItemType, string>()
        {
            { ItemType.Pistol, "RIGHT_THIGH" },
            { ItemType.CombatPistol, "RIGHT_THIGH" },
            { ItemType.Pistol50, "RIGHT_THIGH" },
            { ItemType.SNSPistol, "RIGHT_THIGH" },
            { ItemType.HeavyPistol, "RIGHT_THIGH" },
            { ItemType.VintagePistol, "RIGHT_THIGH" },
            { ItemType.MarksmanPistol, "RIGHT_THIGH" },
            { ItemType.Revolver, "RIGHT_THIGH" },
            { ItemType.APPistol, "RIGHT_THIGH" },
            { ItemType.FlareGun, "RIGHT_THIGH" },
            { ItemType.DoubleAction, "RIGHT_THIGH" },
            { ItemType.PistolMk2, "RIGHT_THIGH" },
            { ItemType.SNSPistolMk2, "RIGHT_THIGH" },
            { ItemType.RevolverMk2, "RIGHT_THIGH" },

            { ItemType.MicroSMG, "LEFT_THIGH" },
            { ItemType.MachinePistol, "LEFT_THIGH" },
            { ItemType.SMG, "LEFT_THIGH" },
            { ItemType.AssaultSMG, "LEFT_THIGH" },
            { ItemType.CombatPDW, "LEFT_THIGH" },
            { ItemType.MG, "LEFT_THIGH" },
            { ItemType.CombatMG, "LEFT_THIGH" },
            { ItemType.Gusenberg, "LEFT_THIGH" },
            { ItemType.MiniSMG, "LEFT_THIGH" },
            { ItemType.SMGMk2, "LEFT_THIGH" },
            { ItemType.CombatMGMk2, "LEFT_THIGH" },

            { ItemType.AssaultRifle, "RIGHT_BACK" },
            { ItemType.CarbineRifle, "RIGHT_BACK" },
            { ItemType.AdvancedRifle, "RIGHT_BACK" },
            { ItemType.SpecialCarbine, "RIGHT_BACK" },
            { ItemType.BullpupRifle, "RIGHT_BACK" },
            { ItemType.CompactRifle, "RIGHT_BACK" },
            { ItemType.AssaultRifleMk2, "RIGHT_BACK" },
            { ItemType.CarbineRifleMk2, "RIGHT_BACK" },
            { ItemType.SpecialCarbineMk2, "RIGHT_BACK" },
            { ItemType.BullpupRifleMk2, "RIGHT_BACK" },

            { ItemType.SniperRifle, "LEFT_BACK" },
            { ItemType.HeavySniper, "LEFT_BACK" },
            { ItemType.MarksmanRifle, "LEFT_BACK" },
            { ItemType.HeavySniperMk2, "LEFT_BACK" },
            { ItemType.MarksmanRifleMk2, "LEFT_BACK" },

            { ItemType.PumpShotgun, "LEFT_BACK" },
            { ItemType.SawnOffShotgun, "LEFT_BACK" },
            { ItemType.BullpupShotgun, "LEFT_BACK" },
            { ItemType.AssaultShotgun, "LEFT_BACK" },
            { ItemType.Musket, "LEFT_BACK" },
            { ItemType.HeavyShotgun, "LEFT_BACK" },
            { ItemType.DoubleBarrelShotgun, "LEFT_BACK" },
            { ItemType.SweeperShotgun, "LEFT_BACK" },
            { ItemType.PumpShotgunMk2, "LEFT_BACK" },
        };
        ...
        public static void Event_OnPlayerConnected(Client player)
        {
            player.SetData("WEAPONS_ON_BODY", new Dictionary<string, uint>() { { "RIGHT_BACK", 0 }, { "LEFT_BACK", 0 } });
        }
        private static Dictionary<string, uint> AvailableWeaponsSlots = new Dictionary<string, uint>() { { "RIGHT_BACK", 0 }, { "LEFT_BACK", 0 } };
        ...
        public static void LoadAllBackWeapons(Client player)
        {
            List<nItem> weapons = nInventory.Items[Main.Players[player].UUID].FindAll(i => (
                nInventory.WeaponsItems.Contains(i.Type) &&
                AvailableWeaponsSlots.ContainsKey(WeaponsSlots[i.Type]))
            );

            foreach (var weapon in weapons)
            {
                ChangeBackWeapon(player, weapon.Type, false);
            }
        }
        ...
        public static void RemoveAll(Client player, bool ammo)
        {
            ...
            {
                if (i >= nInventory.Items[UUID].Count)
                {
                    continue;
                }

                if (
                    nInventory.WeaponsItems.Contains(nInventory.Items[UUID][i].Type) ||
                    nInventory.Items[UUID][i].Type == ItemType.StunGun ||
                    nInventory.MeleeWeaponsItems.Contains(nInventory.Items[UUID][i].Type) ||
                    (ammo && nInventory.AmmoItems.Contains(nInventory.Items[UUID][i].Type))
                )
                {
                    ChangeBackWeapon(player, nInventory.Items[UUID][i].Type, true);
