                    ...
                    case Type.Character:
                        {
                            if (acc.RedBucks < 100)
                            {
                                Notify.Send(client, NotifyType.Error, NotifyPosition.BottomCenter, "Недостаточно NantBucks!", 3000);
                                return;
                            }
                    ...
                    case Type.Warn:
                        {
                            ...
                            Main.Accounts[client].RedBucks -= 125;
                            GameLog.Money(acc.Login, "server", 125, "donateWarn");
                    ...
                    case Type.Slot:
                        {
                            ...
                            GameLog.Money(acc.Login, "server", 500, "donateSlot");
