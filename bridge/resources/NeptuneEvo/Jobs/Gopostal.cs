    ...
    class Gopostal : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Посылки"), Coords[0] + new Vector3(0, 0, 0.3), 10F, 0.6F, 0, new Color(36, 216, 240));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Взять рабочий транспорт"), Coords[1] + new Vector3(0, 0, 0.3), 10F, 0.6F, 0, new Color(36, 216, 240));

            }
            catch (Exception e) { Log.Write("ResourceStart: " + e.Message, nLog.Type.Error); }
        }

        private static int checkpointPayment = 150;
