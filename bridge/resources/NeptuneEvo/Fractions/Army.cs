        ...
        private static void callback_armycombat(Client client, Menu menu, Menu.Item item, string eventName, dynamic data)
        {
            ...
            switch (item.ID)
            {
                ...
                case "cam7": // ANG
                    if (gender)
                    {
                        Customization.SetHat(client, 0, 38);
                        client.SetClothes(1, 122, 0);
                        client.SetClothes(11, 48, 0);
                        client.SetClothes(4, 30, 0);
                        client.SetClothes(8, 15, 0);
                        client.SetClothes(3, 16, 0);
                        client.SetClothes(6, 63, 1);
                        client.SetClothes(7, 33, 0);
                    }
                    else
                    {
                        Customization.SetHat(client, 0, 37);
                        client.SetClothes(1, 122, 0);
                        client.SetClothes(2, 0, 0);
                        client.SetClothes(11, 41, 0);
                        client.SetClothes(4, 29, 0);
                        client.SetClothes(8, 14, 0);
                        client.SetClothes(3, 17, 0);
                        client.SetClothes(6, 66, 1);
                        client.SetClothes(7, 16, 0);
                    }
                    return;
                    case "cam8": // Forma 15 
                    if (gender)
                    {
                        Customization.SetHat(client, 0, 119);
                        client.SetClothes(4, 97, 11);
                        client.SetClothes(11, 251, 11);
                        client.SetClothes(6, 25, 0);
                        client.SetClothes(3, 17, 1);
                        client.SetClothes(1, 24, 1);
                        client.SetClothes(5, 66, 0);
                        client.SetClothes(8, 126, 0);
                        client.SetClothes(1, 52, 1);
                    }
                    else
                    {
                        Customization.SetHat(client, 0, 118);
                        client.SetClothes(4, 100, 11);
                        client.SetClothes(11, 251, 1);
                        client.SetClothes(3, 53, 0);
                        client.SetClothes(6, 25, 0);
                        client.SetClothes(1, 26, 1);
                        client.SetClothes(5, 66, 0);
                        client.SetClothes(8, 156, 0);
                        client.SetClothes(2, 0, 0);
                        client.SetClothes(1, 52, 1);
                    }
                    return;
                    case "cam9": // Forma 16 не сделано
                    if (gender)
                    {
                        Customization.SetHat(client, 0, 119);
                        client.SetClothes(4, 97, 11);
