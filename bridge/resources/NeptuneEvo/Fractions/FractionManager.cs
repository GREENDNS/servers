...
namespace NeptuneEvo.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(590, LSNews.LSNewsCoords[0], 1, 45, Main.StringToU16("Новости"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(419, Cityhall.CityhallChecksCoords[2], 1.5f, 14, Main.StringToU16("Мэрия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(489, Ems.emsCheckpoints[0], 1, 49, Main.StringToU16("Больница"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(540, Fbi.EnterFBI, 1, 58, Main.StringToU16("FIB"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(526, Police.policeCheckpoints[1], 1, 38, Main.StringToU16("Police"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(615, Army.ArmyCheckpoints[2], 1, 28, Main.StringToU16("Порт"), 255, 0, true, 0, 0);
                // NAPI.Blip.CreateBlip(661, Sheriff.sheriffCheckpoints[1], 1, 48, Main.StringToU16("Sheriff"), 255, 0, true, 0, 0);
        ...
        public static SortedList<int, Vector3> FractionSpawns = new SortedList<int, Vector3>()
        {
            ...
            {18, new Vector3(-442.9198, 6016.888, 30.59221)},     // Sheriff
        };
            ...
            else
            {
                switch (clothes)
                {
                    ...
                    case "army_15":
                        ...
                        break;
                    case "sheriff_1":
                        player.SetClothes(11, 26, 1);
                        player.SetClothes(4, 7, 1);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(8, 58, 0);
                        player.SetClothes(3, Customization.CorrectTorso[Main.Players[player].Gender][26], 0);
                        break;
                    case "sheriff_2":
                        player.SetClothes(11, 26, 2);
                        player.SetClothes(4, 22, 5);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(8, 58, 0);
                        player.SetClothes(3, Customization.CorrectTorso[Main.Players[player].Gender][26], 0);
                        break;
                    case "sheriff_3":
                        player.SetClothes(11, 26, 1);
                        player.SetClothes(4, 22, 5);
                        player.SetClothes(6, 20, 0);
                        player.SetClothes(8, 58, 0);
                        player.SetClothes(3, Customization.CorrectTorso[Main.Players[player].Gender][26], 0);
                        break;
                    case "sheriff_4":
                        player.SetClothes(11, 111, 2);
                        player.SetClothes(4, 59, 7);
                        player.SetClothes(6, 35, 0);
                        player.SetClothes(8, 58, 0);
                        player.SetClothes(3, Customization.CorrectTorso[Main.Players[player].Gender][111], 0);
                        break;
                    case "sheriff_5":
                        player.SetClothes(11, 111, 0);
                        player.SetClothes(4, 22, 1);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(8, 58, 0);
                        player.SetClothes(3, Customization.CorrectTorso[Main.Players[player].Gender][1111], 0);
                        break;
                    case "sheriff_6":
                        player.SetClothes(11, 13, 2);
                        player.SetClothes(4, 22, 1);
    ...
    class Stocks : Script
    {
        ...
        private static Dictionary<int, Vector3> stockCoords = new Dictionary<int, Vector3>()
        {
            ...
            { 18, new Vector3(-447.8083, 6008.583, 30.59639)},
        };
