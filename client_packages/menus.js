...
mp.events.add('matsL', (act) => { //load
    ...
    switch (act) {
        case 1:
            global.input.set("Загрузить материалы", "Введите кол-во матов", 4, "loadmats");
            global.input.open();
            break;
        case 2:
            global.input.set("Загрузить материалы", "Введите кол-во матов", 4, "loadmats");
            ...
            break;
        case 3:
            global.input.set("Загрузить наркотики", "Введите кол-во наркоты", 4, "loaddrugs");
            global.input.open();
            break;
        case 4:
...
mp.events.add('matsU', (act) => { //unload
    ...
    switch (act) {
        case 1:
            global.input.set("Выгрузить материалы", "Введите кол-во матов", 4, "unloadmats");
            global.input.open();
            break;
        case 2:
            global.input.set("Выгрузить материалы", "Введите кол-во матов", 4, "unloadmats");
            ...
            break;
        case 3:
            global.input.set("Выгрузить наркотики", "Введите кол-во наркоты", 4, "unloaddrugs");
            global.input.open();
            break;
        case 4:
